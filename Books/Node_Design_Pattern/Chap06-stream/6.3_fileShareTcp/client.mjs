...
async function send(file) {
  ...
  // create new Buffer and allocate 4bytes = 32bits
  const filenameLengthBuffer = Buffer.alloc(4);

  // write in `filenameLengthBuffer` this buffer as a 32bit unsigned integer the length of `filenameBuffer` at offset 0
...
const socket = connect(3000, YOUR_SERVER_IP, async () => {
